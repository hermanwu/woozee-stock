...
export const mockEarnings = [
    ...
    documents: [
      {
        ...
        link: 'https://digitalassets.tesla.com/tesla-contents/image/upload/IR/TSLA-Q1-2024-Update.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 21.301 * BILLION,
        previousValue: 23.329 * BILLION,
  ...
  {
    targetUuids: ['cdns'],
    releasedDate: getUtcDate(2024, 4, 22),
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.cadence.com/en_US/home/company/newsroom/press-releases/pr-ir/2024/cadence-reports-first-quarter-2024-financial-results.html',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.009103 * BILLION,
        previousValue: 1.02169 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 249.956 * MILLION,
        previousValue: 322.463 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 247.643 * MILLION,
        previousValue: 241.804 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['axp'],
    releasedDate: getUtcDate(2024, 4, 19),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s26.q4cdn.com/747928648/files/doc_financials/2024/q1/Q1-2024-Earnings-Press-Release.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 15.801 * BILLION,
        previousValue: 14.281 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['isrg'],
    releasedDate: getUtcDate(2024, 4, 18),
    documents: [
      {
        name: 'Press Release',
        link: 'https://isrg.intuitive.com/news-releases/news-release-details/intuitive-announces-first-quarter-earnings-5',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.8906 * BILLION,
        previousValue: 1.6962 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      ...
      {
        name: EarningsKeyWord.grossProfit,
        value: 1.2454 * BILLION,
        previousValue: 1.113 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ...
    documents: [
      {
        ...
        link: 'https://s22.q4cdn.com/959853165/files/doc_financials/2024/q1/FINAL-Q1-24-Shareholder-Letter.pdf',
      },
    ],
    data: [
      {
  ...
  {
    targetUuids: ['lvs'],
    releasedDate: getUtcDate(2024, 4, 17),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s28.q4cdn.com/640198178/files/doc_financials/2024/q1/LVS-1Q-2024-Earnings-Release.pdf',
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.asml.com/en/news/press-releases/2024/q1-2024-financial-results',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 5.29 * BILLION,
        previousValue: 6.7462 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.euro,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 2.6966 * BILLION,
        previousValue: 3.4132 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.euro,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 1.3914 * BILLION,
        previousValue: 2.205 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.euro,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 1.2238 * BILLION,
        previousValue: 1.9558 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.euro,
      },
    ],
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://s23.q4cdn.com/714267708/files/doc_financials/2023/q4/Blackstone4Q23EarningsPressRelease.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.28502 * BILLION,
        previousValue: 1.704059 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 109.123 * MILLION,
        previousValue: 743.341 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://s28.q4cdn.com/640198178/files/doc_financials/2023/q4/LVS-4Q-2023-Earnings-Release-Final.pdf',
      },
    ],
    data: [
      {
  ...
  {
    targetUuids: ['ms'],
    releasedDate: getUtcDate(2024, 4, 16),
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.morganstanley.com/content/dam/msdotcom/en/about-us-ir/shareholder/1q2024.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 15.136 * BILLION,
        previousValue: 14.517 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.investor.jnj.com/files/doc_financials/2023/q4/4Q23-Press-Release_Final-_With-Guidance-_With-Attachments-1.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 21.383 * BILLION,
        previousValue: 20.894 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 14.872 * BILLION,
        previousValue: 14.207 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.unitedhealthgroup.com/content/dam/UHG/PDF/investors/2024/UNH-Q1-2024-Release.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 99.796 * BILLION,
        previousValue: 91.931 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 21.395 * BILLION,
        previousValue: 19.939 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 14.597 * BILLION,
        previousValue: 13.855 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['unh'],
    releasedDate: getUtcDate(2024, 1, 12),
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.unitedhealthgroup.com/content/dam/UHG/PDF/investors/2023/UNH-Q4-2023-Release.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 94.427 * BILLION,
        previousValue: 82.787 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['jpm:nyse'],
    releasedDate: getUtcDate(2024, 1, 12),
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.jpmorganchase.com/content/dam/jpmc/jpmorgan-chase-and-co/investor-relations/documents/quarterly-earnings/2023/4th-quarter/30e66a2f-5f41-4616-b831-fee985b61b8a.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 38.574 * BILLION,
        previousValue: 34.547 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 38.574 * BILLION - 24.486 * BILLION,
        previousValue: 34.547 * BILLION - 19.022 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
...

  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://s23.q4cdn.com/591718779/files/doc_financials/2023/Q4/EX_99-1-12-31-2023-Earnings-Release-1-16-R10_No-Footers.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 7.3467 * BILLION,
        previousValue: 6.9806 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 3.3545 * BILLION,
        previousValue: 3.2158 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 1.5287 * BILLION,
        previousValue: 1.4536 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['kmx'],
    releasedDate: getUtcDate(2024, 4, 11),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.carmax.com/news-and-events/news/news-details/2024/CarMax-Reports-Fourth-Quarter-and-Fiscal-Year-2024-Results/',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 5.6266 * BILLION,
        previousValue: 5.7225 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['kmx'],
    releasedDate: getUtcDate(2023, 12, 21),
    documents: [
      {
        name: 'Presentation',
        link: 'https://investors.carmax.com/news-and-events/news/news-details/2023/CarMax-Reports-Third-Quarter-Fiscal-2024-Results/',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 6.1485 * BILLION,
        previousValue: 6.506 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['stz'],
    releasedDate: getUtcDate(2024, 1, 5),
    documents: [
      {
        name: 'Presentation',
        link: 'https://d1io3yog0oux5.cloudfront.net/_8be69345a860cb1ba0137c5205a0649f/cbrands/db/887/7818/file/03.+Quarterly+Deck.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.4709 * BILLION,
        previousValue: 2.4365 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 1.2706 * BILLION,
        previousValue: 1.2269 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['kbh:nyse'],
    releasedDate: getUtcDate(2024, 1, 20),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s201.q4cdn.com/124745054/files/doc_financials/2023/q4/KB-Home-Reports-2023-Fourth-Quarter-and-Full-Year-Results-2024.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.673988 * BILLION,
        previousValue: 1.94003 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      ...
      {
        name: EarningsKeyWord.netIncome,
        value: 150.302 * MILLION,
        previousValue: 216.41 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['chwy:nyse'],
    releasedDate: getUtcDate(2023, 12, 6),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s23.q4cdn.com/610444331/files/doc_financials/2023/q3/CHWY-Q3-2023-Press-Release-FINAL.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.738 * BILLION,
        previousValue: 2.532 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 0.780761 * BILLION,
        previousValue: 0.720177 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: -0.010157 * BILLION,
        previousValue: -0.434 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: -0.03581 * BILLION,
        previousValue: 2.311 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['acn:nyse'],
    releasedDate: getUtcDate(2023, 3, 21),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investor.accenture.com/~/media/Files/A/Accenture-IR-V3/quarterly-earnings/2024/q2fy24/accenture-reports-second-quarter-fiscal-2024-results-.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 15.799514 * BILLION,
        previousValue: 15.814158 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 15.799514 * BILLION - 10.921045 * BILLION,
        previousValue: 15.814158 * BILLION - 10.979392 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 2.046427 * BILLION,
        previousValue: 1.944581 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 1.709202 * BILLION,
        previousValue: 1.550683 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['nke:nyse'],
    releasedDate: getUtcDate(2023, 12, 21),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s1.q4cdn.com/806093406/files/doc_financials/2024/q2/FY24-Q2-Combined-NIKE-Press-Release-Schedules-FINAL.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 13.388 * BILLION,
        previousValue: 13.315 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['nke:nyse'],
    releasedDate: getUtcDate(2024, 3, 21),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.nike.com/investors/news-events-and-reports/investor-news/investor-news-details/2024/NIKE-Inc.-Reports-Fiscal-2024-Third-Quarter-Results/default.aspx',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 12.429 * BILLION,
        previousValue: 12.39 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['fdx:nyse'],
    releasedDate: getUtcDate(2023, 12, 19),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.fedex.com/news-and-events/investor-news/investor-news-details/2023/FedEx-Reports-Higher-Second-Quarter-Diluted-EPS-of-3.55-and-Adjusted-Diluted-EPS-of-3.99/default.aspx',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 22.165 * BILLION,
        previousValue: 22.814 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://s21.q4cdn.com/665674268/files/doc_financials/2024/q3/FedEx-Q3-FY24-Earnings-Release.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 21.738 * BILLION,
        previousValue: 22.169 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['lulu:nasdaq'],
    releasedDate: getUtcDate(2023, 12, 7),
    documents: [
      {
        name: 'Press Release',
        link: 'https://corporate.lululemon.com/media/press-releases/2023/12-07-2023',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.204218 * BILLION,
        previousValue: 1.856889 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 1.256664 * BILLION,
        previousValue: 1.038852 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 338.115 * MILLION,
        previousValue: 352.427 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 248.714 * MILLION,
        previousValue: 255.47 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://corporate.lululemon.com/media/press-releases/2024/03-21-2024-200524108',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 3.205103 * BILLION,
        previousValue: 2.771838 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 1.903425 * BILLION,
        previousValue: 1.527619 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 913.89 * MILLION,
        previousValue: 314.426 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 669.468 * MILLION,
        previousValue: 119.811 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['chwy:nyse'],
    releasedDate: getUtcDate(2024, 3, 20),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s23.q4cdn.com/610444331/files/doc_financials/2023/q4/CHWY-Q4-2023-Shareholder-Letter-FINAL-v2.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.8259 * BILLION,
        previousValue: 2.7128 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 798.085 * MILLION,
        previousValue: 761.417 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: -21.981 * MILLION,
        previousValue: 16.396 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 31.886 * MILLION,
        previousValue: 6.784 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['mu:nasdaq'],
    releasedDate: getUtcDate(2024, 3, 20),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.micron.com/news-releases/news-release-details/micron-technology-inc-reports-results-second-quarter-fiscal-2024',
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://s23.q4cdn.com/714267708/files/doc_downloads/2024/Earnings/Blackstone1Q24EarningsPressRelease.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 3.687828 * BILLION,
        previousValue: 1.381845 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      ...
      {
        name: EarningsKeyWord.netIncome,
        value: 1.595983 * BILLION,
        previousValue: 210.681 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://investor.accenture.com/~/media/Files/A/Accenture-IR-V3/quarterly-earnings/2024/q1fy24/accenture-reports-first-quarter-fiscal-2024-results.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 16.224303 * BILLION,
        previousValue: 15.747802 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 16.224303 * BILLION - 10.776362 * BILLION,
        previousValue: 15.747802 * BILLION - 10.56166 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 2.564887 * BILLION,
        previousValue: 2.5931 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 2.009981 * BILLION,
        previousValue: 1.9963 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['dri:nyse'],
    releasedDate: getUtcDate(2023, 12, 15),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investor.darden.com/news/news-details/2023/Darden-Restaurants-Reports-Fiscal-2024-Second-Quarter-Results-Declares-Quarterly-Dividend-And-Updates-Fiscal-2024-Financial-Outlook/',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.7273 * BILLION,
        previousValue: 2.4865 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['gis:nyse'],
    releasedDate: getUtcDate(2024, 3, 20),
    documents: [
      {
        name: 'Press Release',
        link: 'https://s29.q4cdn.com/993087495/files/doc_financials/2024/q3/F24Q3-Press-Release-FINAL.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 5.0992 * BILLION,
        previousValue: 5.1259 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 5.0992 * BILLION * 0.335,
        previousValue: 5.1259 * BILLION * 0.325,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://s24.q4cdn.com/589059658/files/doc_earnings/2023/q4/earnings-result/2024-02-22-EX-99-1.pdf',
      },
    ],
    data: [
      {
  ...
  {
    targetUuids: ['payx:nasdaq'],
    releasedDate: getUtcDate(2023, 11, 30),
    documents: [
      {
        name: 'Press Release',
        link: 'https://d1io3yog0oux5.cloudfront.net/_df6b8bb70b3c994ec97a71081f16e53b/paychex/news/2023-12-21_Paychex_Inc_Reports_Second_Quarter_and_Mid_year_731.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.2579 * BILLION,
        previousValue: 1.1903 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 1.2579 * BILLION - 364.1 * MILLION,
        previousValue: 1.1903 * BILLION - 359.3 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://investor.gamestop.com/news-releases/news-release-details/gamestop-discloses-third-quarter-2023-results',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.0783 * BILLION,
        previousValue: 1.1864 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['gds:nasdaq'],
    releasedDate: getUtcDate(2023, 11, 22),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.gds-services.com/system/files-encrypted/nasdaq_kms/assets/2023/11/22/5-27-56/GDS%203Q23%20ER%201122%20FINAL.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.367593 * BILLION,
        previousValue: 2.519033 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 492.805 * MILLION,
        previousValue: 447.449 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 146.979 * MILLION,
        previousValue: 80.682 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 339.663 * MILLION,
        previousValue: 420.831 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
    ],
...

  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://investor.walgreensbootsalliance.com/news-releases/news-release-details/walgreens-boots-alliance-reports-fiscal-2024-first-quarters',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 36.707 * BILLION,
        previousValue: 33.382 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['brze:nasdaq'],
    releasedDate: getUtcDate(2024, 3, 27),
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.braze.com/files/doc_financials/2024/q4/2024-01-31-Braze-Inc-FY-24-Earnings-Release.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 130.957 * MILLION,
        previousValue: 98.675 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 87.965 * MILLION,
        previousValue: 65.25 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: -32.293 * MILLION,
        previousValue: -36.52 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: -28.578 * MILLION,
        previousValue: -33.808 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
...

  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.braze.com/files/doc_financials/2024/q3/braze-inc-q3-24-earnings-release-final.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 123.956 * MILLION,
        previousValue: 93.125 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 87.582 * MILLION,
        previousValue: 63.99 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: -35.133 * MILLION,
        previousValue: -36.864 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: -30.976 * MILLION,
        previousValue: -33.892 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://d1io3yog0oux5.cloudfront.net/_fbc2bbf2a321ee57dcd39273f8654309/rh/db/3478/32264/shareholder_letter/RH+Q4+2023+Financial+Results+and+Shareholder+Letter.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 738.26 * MILLION,
        previousValue: 772.499 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 320.951 * MILLION,
        previousValue: 369.406 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 64.255 * MILLION,
        previousValue: 112.205 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 11.381 * MILLION,
        previousValue: 106.896 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
    ],
  ...
  {
    targetUuids: ['ngs:nyse'],
    releasedDate: getUtcDate(2024, 3, 27),
    documents: [
      {
        name: 'Press Release',
        link: 'https://naturalgasservices.gcs-web.com/news-releases/news-release-details/natural-gas-services-group-inc-reports-its-third-quarter-2023',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 31.369 * MILLION,
        previousValue: 22.043 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['play:nasdaq'],
    releasedDate: getUtcDate(2024, 4, 2),
    documents: [
      {
        name: 'Press Release',
        link: 'https://ir.daveandbusters.com/news-releases/news-release-details/dave-busters-reports-fourth-quarter-and-fiscal-year-end-2023',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 599.1 * MILLION,
        previousValue: 563.8 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 599.1 * MILLION - 90.3 * MILLION,
        previousValue: 563.8 * MILLION - 87.1 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://ir.daveandbusters.com/news-releases/news-release-details/dave-busters-reports-third-quarter-2023-financial-results',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 466.9 * MILLION,
        previousValue: 481.2 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 466.9 * MILLION - 72.8 * MILLION,
        previousValue: 481.2 * MILLION - 76.2 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['pvh:nyse'],
    releasedDate: getUtcDate(2024, 4, 1),
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.pvh.com/-/media/Files/pvh/investor-relations/PVH-Full-Year-2023-Earnings.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2489.9 * MILLION,
        previousValue: 2488.7 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 1501.2 * MILLION,
        previousValue: 1390.5 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.pvh.com/-/media/Files/pvh/investor-relations/PVH-Q3-2023-Earnings.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2362.9 * MILLION,
        previousValue: 2280.8 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 1339.4 * MILLION,
        previousValue: 1274.2 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://d1io3yog0oux5.cloudfront.net/_e20f9062035f17f022090129cfcf7cd2/rh/db/3478/32252/shareholder_letter/RH+Q3+2023+Financial+Results+and+Shareholder+Letter.pdf',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 751.225 * MILLION,
        previousValue: 869.066 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 340.45 * MILLION,
        previousValue: 420.778 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 51.236 * MILLION,
        previousValue: 170.25 * MILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  {
    targetUuids: ['ccl:nyse'],
    releasedDate: getUtcDate(2024, 3, 20),
    documents: [
      {
        name: 'Press Release',
        link: 'https://www.carnivalcorp.com/static-files/6e9f2f9b-0b4f-4e3b-9c4d-1d3b9b5b6e9b',
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://ir.mccormick.com/news-releases/news-release-details/mccormick-reports-2023-financial-results-and-provides-2024',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 1.7528 * BILLION,
        previousValue: 1.6957 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://investor.pddholdings.com/static-files/8c935dcd-f4a8-4983-844c-a8bcc72ebee7',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 88.881036 * BILLION,
        previousValue: 39.820028 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
      {
        name: EarningsKeyWord.grossProfit,
        value: 88.881036 * BILLION - 35.078272 * BILLION,
        previousValue: 39.820028 * BILLION - 8.926705 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
      {
        name: EarningsKeyWord.operatingIncome,
        value: 22.394968 * BILLION,
        previousValue: 9.113735 * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.rmb,
      },
      {
        name: EarningsKeyWord.netIncome,
        value: 23.280309 * BILLION,
  ...
  },
  {
    ...
    documents: [
      {
        name: 'Press Release',
        link: 'https://investors.micron.com/news-releases/news-release-details/micron-technology-inc-reports-results-first-quarter-fiscal-2024',
      },
    ],
    data: [
      {
  ...
  {
    targetUuids: ['now'],
    releasedDate: getUtcDate(2024, 4, 24),
    documents: [
      {
        name: 'Presentation',
        link: 'https://www.servicenow.com/content/dam/servicenow/other-documents/investor-relations/investor-presentations/servicenow-q1-2024-investor-presentation.pdf',
      },
      {
        name: 'Press Release',
        link: 'https://www.servicenow.com/company/media/press-room/first-quarter-2024-financial-results.html',
      },
    ],
    data: [
      {
        name: EarningsKeyWord.revenue,
        value: 2.603 * BILLION,
        previousValue: (2.603 / 1.24) * BILLION,
        timeFrame: TimeFrame.yoy,
        unit: UnitType.dollar,
      },
      {
