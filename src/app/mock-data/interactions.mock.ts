...
export const userInteractions: UserInteractions[] = [
...

  {
    ...
    listUuids: ['spatial-computing', 'magnificent-7'],
    vote: 50,
    targetPrice: 160,
  },
  {
    ...
    listUuids: ['good-earnings', 'gen-ai', 'magnificent-7'],
    vote: 15,
    targetPrice: 160,
  },
  {
  ...
  },
  {
    ...
    listUuids: ['magnificent-7', 'worse-earnings', 'proprietary-data'],
    vote: 35,
    targetPrice: 170,
  },
  {
    ...
    listUuids: ['good-earnings', 'magnificent-7', 'gen-ai', 'proprietary-data'],
    vote: 60,
    targetPrice: 130,
  },
  {
    ...
    listUuids: ['good-earnings', 'gen-ai'],
    vote: 199,
    targetPrice: 470,
  },
  {
