...
import { AutoGeneratedRiskService } from 'src/app/risks/services/auto-generated-risk.service';
    ...
    this.routeSub = this.route.params.subscribe((params) => {
      ...
      if (this.stockAnalysis) {
        this.risks = [
          ...
          ...this.subjectiveDataService.getRisksByMarkets(
            this.stockAnalysis?.business?.markets
          ),
        ];

        this.risks.push(
          ...this.autoGeneratedRiskService.getProfitabilityRisks(
            this.stockAnalysis
          )
        );
        ...
        this.catalysts = [
          ...
          ...this.subjectiveDataService.getCatalystsByMarkets(
            this.stockAnalysis?.business?.markets
          ),
        ];
